<template>
	<view class="uni-tab-bar">
		<!-- <view class="uni-flex uni-row"> -->
			<!-- <view class="text" style="width: 250upx;" @click="chooseCate">{{defaultCate}}</view> -->
...
<script>
	...
	export default {
		...
		onLoad: function(event) {
			...
			this.changeBtn(this.defaultCate);
		...
		methods: {
			...
			onConfirm(e) {
				...
				this.loadNavList(1);
				this.changeBtn(e.label);
				uni.showTabBar();
			},
			changeBtn(defaultCate){
				// #ifdef APP-PLUS
				...
				titleObj.buttons[1].text = defaultCate;
