<template>
	<view class="container">
		...
		<view class="list-cell b-b" @click="navTo('/pages/ucenter/about')" hover-class="cell-hover" :hover-stay-time="50">
			<text class="cell-tit">关于中纸网</text>
			<text class="cell-more yticon icon-you"></text>
		</view>
		...
		<view class="list-cell log-out-btn" @click="toOut">
